...
class CategoryServiceTest {
  ...
  void findByName() {
    ...
    Mockito.when(repository.findByName("category sample")).thenReturn(Optional.of(found));

    assertDoesNotThrow(() -> service.findByName("category sample"));
    assertNotNull(service.findByName("category sample"));
    assertEquals(found, service.findByName("category sample"));
