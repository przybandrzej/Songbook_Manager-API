...
ALTER SEQUENCE verses_id_seq OWNED BY verses.id;

ALTER TABLE ONLY authors ALTER COLUMN id SET DEFAULT nextval('authors_id_seq'::regclass);

ALTER TABLE ONLY categories ALTER COLUMN id SET DEFAULT nextval('categories_id_seq'::regclass);

ALTER TABLE ONLY guitar_cords ALTER COLUMN id SET DEFAULT nextval('guitar_cords_id_seq'::regclass);
...
ALTER TABLE ONLY guitar_cords
    ADD CONSTRAINT guitar_cords_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY verses
    ADD CONSTRAINT fk2jnpdm62r7c25xxhxtr2y02t6 FOREIGN KEY (song_id) REFERENCES songs(id);
...
ALTER TABLE ONLY lines
    ADD CONSTRAINT fk8gf0b7md5fgornhl83funxo9e FOREIGN KEY (verse_id) REFERENCES verses(id);
...
ALTER TABLE ONLY guitar_cords
    ADD CONSTRAINT fkrxxfs562j6xwvyj4x9ntrlgwj FOREIGN KEY (line_id) REFERENCES lines(id);
